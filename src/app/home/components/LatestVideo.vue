...
<template>
    <div class="overflow-hidden">
        <Container>
            <div
                class="relative flex flex-col gap-4 py-40 lg:flex-row lg:gap-8 lg:items-center xl:max-w-4/5 xl:mx-auto"
            >
                ...
                <div class="z-10 flex-1">
                    <!-- <div class="flex items-center gap-2 font-bold text-muted-more text-shadow-md">
                    ...
                    <div class="text-md font-bold text-muted md:text-xl">
