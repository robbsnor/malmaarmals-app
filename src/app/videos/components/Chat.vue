  ...
  >
    <template v-if="!videoStore.messagesLoading">
      <template v-if="videoStore.messages.length">
        ...
        >
          <div>
            ...
            <div class="text-muted">
              A: Not all users that should have a sub-badge, have one displayed.
              Even on the original stream replay they are missing.
            </div>
          </div>
        </Dialog>
        ...
        <div
          v-visible="userHasScrolledUp"
          class="absolute right-0 bottom-0 pb-4 left-0 flex justify-center"
        >
          <div
