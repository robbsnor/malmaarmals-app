...
function maximizePlayer() {
    router.push({ name: 'stream', params: { id: videoStore.id }, query: { playlistId: videoStore.playlistId } });
}
...
<template>
    <button
        ...
        class="z-video-controls-mini absolute inset-0 flex justify-between items-start p-2"
