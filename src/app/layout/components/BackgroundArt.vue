        ...
        <Container class="relative h-full">
            <div class="flex gap-4 absolute right-0 translate-x-1/6 h-full">
                <div
                    v-for="i in 3"
                    :key="i"
                    class="w-80 h-full pr-[1px] bg-gradient-to-br from-black-100 to-primary -skew-x-25"
                >
                    <div class="w-full h-full bg-gradient-to-br from-black-100 to-black-100/50"></div>
                </div>
            </div>
        </Container>

        <div
            class="absolute inset-0 bg-gradient-to-b from-transparent via-30% via-black-100/60 lg:via-transparent lg:to-100% to-black-100"
        ></div>
    </div>
</template>
