...
import MobilePage from './app/shared/components/MobilePage.vue';
import PWAInstallButton from './app/shared/components/PWAInstallButton.vue';
...
app.component('MobilePage', MobilePage);
app.component('PWAInstallButton', PWAInstallButton);
